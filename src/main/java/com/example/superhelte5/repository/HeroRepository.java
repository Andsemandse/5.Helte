...
public class HeroRepository {
    ...
    public List<DTOCreationYear> getHeroInfo(){
        List<DTOCreationYear> heroList = new ArrayList<>();
        ...
        try(Connection con = DriverManager.getConnection(url,user,pwd)) {
            ...
            while(rs.next()) {
                heroList.add(new DTOCreationYear(
    ...
    public DTOHeroPowers getHeroPower(String name){
        DTOHeroPowers superheroPower = null;
        ...
        try(Connection con = DriverManager.getConnection(url,user,pwd)) {
            ...
            while(rs.next()) {
                ...
                if(currentName.equals(heroName)) {
                    ...
                    superheroPower = new DTOHeroPowers(heroName, new ArrayList<>(List.of(superpower)));
    ...
    public void addSuperHero(DTOHeroForm form) {
        try (Connection con = DriverManager.getConnection(url, user, pwd)) {
            // ID's
            int cityId = 0;
            int heroId = 0;
